...
public class Login extends javax.swing.JFrame {
    ...
    private void Autenticar() {
        ...
        dados.login(txtUsername.getText(), new String(txtPassword.getPassword()));

        if (dados.isUtilizadorAutenticado() == true) {
            dispose();
    ...
    private void btnRegistoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistoActionPerformed
        ...
        RegistarUtilizador registo = new RegistarUtilizador(dados);
